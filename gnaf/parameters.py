    ...
    class gnaf_nov_2020:
        ...
        class CSVFormat:
            ...
            def __init__(self):
                ...
                self.Format = 'CSV'
                self.PathToFiles = 'NOV20_GNAF_PipeSeparatedValue/G-NAF/G-NAF_NOVEMBER_2020/'
                self.FilePath = 'AUG20_GNAF_PipeSeparatedValue{slash}G-NAF{slash}G-NAF_NOV_2020{slash}Standard{slash}ACT_ADDRESS_ALIAS_psv.psv'
                ...
                self.ZipDir = 'csv'
                self.ZipPath ='nov20_gnaf_pipeseparatedvalue.zip'

    class gnaf_nov_2020_gda2020:
        """
        G-NAF DataSet November2020 GDA 2020
        """  
        ...
        ...
        class CSVFormat:
            ...
            def __init__(self):
                ...
                self.Format = 'CSV'
                self.PathToFiles = 'NOV20_GNAF_PipeSeparatedValue_GDA2020/G-NAF/G-NAF_NOVEMBER_2020/'
                self.FilePath = 'NOV20_GNAF_PipeSeparatedValue_GDA2020{slash}G-NAF{slash}G-NAF_NOVEMBER_2020{slash}Standard{slash}ACT_ADDRESS_ALIAS_psv.psv'
                ...
                self.ZipDir = 'csv'
                self.ZipPath ='nov20_gnaf_pipeseparatedvalue_gda2020.zip' 
                
    class gnaf_aug_2020:
        """
        G-NAF DataSet August 2020 
        """  
        ...
        ...
        class CSVFormat:
            ...
            def __init__(self):
                self.Description = 'gnaf_aug_2020'
                self.Format = 'CSV'
                self.PathToFiles = 'AUG20_GNAF_PipeSeparatedValue/G-NAF/G-NAF_AUGUST_2020/'
                self.FilePath = 'AUG20_GNAF_PipeSeparatedValue{slash}G-NAF{slash}G-NAF_AUG_2020{slash}Standard{slash}ACT_ADDRESS_ALIAS_psv.psv'
                self.DownURL = 'https://data.gov.au/data/dataset/19432f89-dc3a-4ef3-b943-5326ef1dbecc/resource/4b084096-65e4-4c8e-abbe-5e54ff85f42f/download/aug20_gnaf_pipeseparatedvalue.zip'
                self.ZipDir = 'csv'
                self.ZipPath ='aug20_gnaf_pipeseparatedvalue.zip'

    class gnaf_aug_2020_gda2020:
        """
        G-NAF DataSet August 2020 GDA 2020
        """  
        ...
        ...
        class CSVFormat:
            ...
            def __init__(self):
                self.Description = 'gnaf_aug_2020_gda2020'
                self.Format = 'CSV'
                self.PathToFiles = 'AUG20_GNAF_PipeSeparatedValue_GDA2020/G-NAF/G-NAF_AUGUST_2020/'
                self.FilePath = 'AUG20_GNAF_PipeSeparatedValue_GDA2020{slash}G-NAF{slash}G-NAF_AUGUST_2020{slash}Standard{slash}ACT_ADDRESS_ALIAS_psv.psv'
                self.DownURL = 'https://data.gov.au/data/dataset/19432f89-dc3a-4ef3-b943-5326ef1dbecc/resource/fdce090a-b356-4afe-91bb-c78fbf88082a/download/aug20_gnaf_pipeseparatedvalue_gda2020.zip'
                self.ZipDir = 'csv'
                self.ZipPath ='aug20_gnaf_pipeseparatedvalue_gda2020.zip' 
    
    class gnaf_may_2020:
        """
        G-NAF DataSet May 2020 
        """  
        ...
        ...
        class CSVFormat:
            ...
            def __init__(self):
                self.Description = 'gnaf_may_2020'
                self.Format = 'CSV'
                self.PathToFiles = 'MAY20_GNAF_PipeSeparatedValue/G-NAF/G-NAF_MAY_2020/'
                self.FilePath = 'MAY20_GNAF_PipeSeparatedValue{slash}G-NAF{slash}G-NAF_MAY_2020{slash}Standard{slash}ACT_ADDRESS_ALIAS_psv.psv'
                self.DownURL = 'https://data.gov.au/data/dataset/19432f89-dc3a-4ef3-b943-5326ef1dbecc/resource/4b084096-65e4-4c8e-abbe-5e54ff85f42f/download/may20_gnaf_pipeseparatedvalue.zip'
                self.ZipDir = 'csv'
                self.ZipPath ='may20_gnaf_pipeseparatedvalue.zip'

    class gnaf_may_2020_gda2020:
        """
        G-NAF DataSet May 2020 GDA 2020
        """  
        ...
        ...
        class CSVFormat:
            ...
            def __init__(self):
                self.Description = 'gnaf_may_2020_gda2020'
                self.Format = 'CSV'
                self.PathToFiles = 'MAY20_GNAF_PipeSeparatedValue_GDA2020/G-NAF/G-NAF_MAY_2020/'
                self.FilePath = 'MAY20_GNAF_PipeSeparatedValue_GDA2020{slash}G-NAF{slash}G-NAF_MAY_2020{slash}Standard{slash}ACT_ADDRESS_ALIAS_psv.psv'
                self.DownURL = 'https://data.gov.au/data/dataset/19432f89-dc3a-4ef3-b943-5326ef1dbecc/resource/fdce090a-b356-4afe-91bb-c78fbf88082a/download/may20_gnaf_pipeseparatedvalue_20200518150229.zip'
                self.ZipDir = 'csv'
                self.ZipPath ='may20_gnaf_pipeseparatedvalue_gda2020.zip'
